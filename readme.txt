# Java XML to MySQL Data Transfer

## Description

This project is a Java desktop application that imports data from an intermediate XML file into a MySQL database. It includes a graphical user interface (GUI) that allows users to:
...
2. Import the project into your IDE (VS-Code, e.g., IntelliJ IDEA, Eclipse).
...
4. The app will insert the data into the selected MySQL database.
